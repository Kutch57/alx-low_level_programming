...
/**
 * check97 - This checks for the correct number of arguments.
...
/**
 * check99 - THis checks that file_to was created and/or can be written to.
...
/**
 * check100 - THis checks that file descriptors were closed properly.
 ...
 * @argv: Means an array of pointers to the arguments.
 *
 * Return: 0 on success.
 */
